...
import PaymentHistory from '../../../../components/patron/Profile/PaymentHistory/PaymentHistory';
import style from './PaymentHistoryPage.module.scss'
       ...
       <div >
          ...
          <div className={style.container}>
             ...
             <div className={style.content}>
                <PaymentHistory user_details={patronDetails} />
             </div>
          </div>
       </div>
    )
