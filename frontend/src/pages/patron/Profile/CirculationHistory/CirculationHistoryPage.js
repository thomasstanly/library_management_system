...
import CirculatioReport from '../../../../components/patron/Profile/CirculationReport/CirculatioReport';
import style from './CirculationHistoryPage.module.scss'

const CirculationHistoryPage = () => {
       ...
       <div >
          ...
          <div className={style.container}>
             ...
             <div className={style.content}>
                <CirculatioReport user_details={patronDetails} />
             </div>
          </div>
       </div>
    )
...
export default CirculationHistoryPage